...
_ATTRS = [
    ...
    ("offsetTranslateX", "Offset translate X (m)", "float"),
    ("offsetTranslateY", "Offset translate Y (m)", "float"),
    ("offsetTranslateZ", "Offset translate Z (m)", "float"),
    ("offsetRotateX", "Offset rotate X (rad)", "float"),
    ("offsetRotateY", "Offset rotate Y (rad)", "float"),
    ("offsetRotateZ", "Offset rotate Z (rad)", "float"),
